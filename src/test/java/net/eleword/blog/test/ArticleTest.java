...
//		 index.delete(getArticles());
	...
	public List<Article> getArticles() {
		...
		articles.add(new Article(1, "网络安全在当今互联网中的位置", "计划2020年开通，从四季青桥始发至东田阳附近，距离项目20分钟车程"));
		articles.add(new Article(2, "开启北京自住房万元时代", "紫峰•九院城位于通州于家务次中心CED中央生态区，张凤路与大德路交汇处，总规划约60万㎡，分三期开发。一期近23万平米"));
		articles.add(new Article(3, "多维交通 立体路网 一城繁华 触手可及", "项目距离国贸32公里，距通州新城18公里，项目临近京哈"));
		articles.add(new Article(4, "郊90空调", "项目距离国贸32公里，距通州新城18公里网络，项目临近京哈"));
		articles.add(new Article(5, "公路交通", "项目距离国贸32公里，距通州新城18公里，项目临近京哈"));
		return articles;
	}
}
